...
public interface MessageConstant {
    ...
    static final String SEND_VALIDATECODE = "验证码已发送请查看短信或手机号是否正确";
    static final String SEND_VALIDATECODE_SUCCESS = "验证码发送成功";
    static final String SEND_VALIDATECODE_NONE = "验证码不存在请重新发送";
    static final String IMPORT_VALIDATECODE_ERROR = "验证码不不正确请核对后重新输入";
